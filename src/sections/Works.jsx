...
const Works = () => {
  const text = `Showcasing featured projects crafted with passion, 
...
and lasting impact.`;
  ...
  /*
  💡 SIMPLE ANALOGY:
  IMAGINE YOU HAVE A SMALL PREVIEW IMAGE THAT NEEDS TO FOLLOW THE MOUSE.
  IF YOU USE GSAP.TO(), A NEW ANIMATION WOULD BE CREATED FOR EVERY MOVE, WHICH CAN GET LAGGY.
  QUICKTO() ACTS LIKE A READY-MADE SMOOTH SLIDER FUNCTION THAT YOU CAN CALL ON EVERY NEW MOUSE POSITION TO CREATE A SMOOTH TRANSITION.
  */
  useGSAP(() => {
  ...
  const handleMouseLeave = (index) => {
    ...
    gsap.killTweensOf(el); // KILL THE EXISTING ANIMATION IF ANY
    ...
    <section id="work" className="flex flex-col min-h-screen">
      ...
      >
        {projects.map((project, index) => (
          <a href={project.href} target="_blank" key={project.id}>
            <div
              key={project.id}
              id="project"
            ...
            >
              ...
              <div className="relative flex items-center justify-center px-5 sm:px-10 md:hidden h-[400px]">
                ...
                <img
                  ...
                  className="absolute px-14 rounded-xl bg-center"
                />
              </div>
            </div>
          </a>
